    ...
    <div class="wrapper d-flex align-items-stretch">
        <header class="header" id="header">
            ...
            <div class="dropdown" style="display: flex; align-items: center; gap: 8px;">
                <div class="header_img" style="width: 40px;" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <img src="https://i.imgur.com/hczKIze.jpg" alt="" />
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                    aria-expanded="false" style="width: 40px;" height="16" width="10"
