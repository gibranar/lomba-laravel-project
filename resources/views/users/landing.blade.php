...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&family=Roboto:wght@400;500;700&family=Ruda:wght@400;500&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            <h1 class="logo"><a href="index.html">Perlombaan<span>.</span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#about">Kategori</a></li>
                    <li><a class="nav-link scrollto" href="#services">Persyaratan</a></li>
                    <li><a class="nav-link scrollto" href="#team">Timeline</a></li>
                    <li><a class="nav-link scrollto" href="#team">Statistik</a></li>
                    <li><a class="nav-link scrollto" href="#team">Peringkat</a></li>
                    <li class="dropdown"><a href="#"><span>Download</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#">Panduan LIP3D 2</a></li>
                            ...
                            <li><a href="#">Logo LIP3D 2 </a></li>
                            <li><a href="#">Format Administrasi LIP3D 2</a></li>
                            <li><a href="#">Pamflate LIP3D 2</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1>Lomba Inovasi Program Pemberdayaan<span>dan Pembangunan Desa</span></h1>
            <h2>LIP3D merupakan wadah dan ajang lomba yang diharapkan mampu mendorong pemikiran/gagasan
                mahasiswa di Indonesia yang unggul, kreatif, inovatif dan berkelanjutan dalam mengembang kemiskinan
                di wilayahnya masing-masing
            </h2>
            <div class="d-flex">
                <a href="#about" class="btn-get-started scrollto">Daftar Lomba</a>
                <a href="#about" class="btn-get-started scrollto ms-4">Masuk Sistem</a>
                <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox btn-watch-video ms-4 mt-2"><i
                        class="bi bi-play-circle"></i><span>Watch Video Registration</span></a>
            </div>
        </div>
    </section>
    <!-- End Hero -->
    ...
    <footer id="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Statistik</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#">Peringkat</a></li>
                        </ul>
                    </div>
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span>Way</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Way</a>
            </div>
        </div>
    </footer><!-- End Footer -->
