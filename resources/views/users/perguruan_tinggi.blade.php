                                ...
                                <div class="components-preview mx-auto">
                                    ...
                                    <div class="nk-block nk-block-lg">
                                        <div class="nk-block-head">
                                            <div class="nk-block-head-content">
                                                <h4 class="title nk-block-title">Data Perguruan Tinggi</h4>
                                                ...
                                                <div class="card">
                                                    <div class="card-inner">
                                                        <form action=""
                                                            ...
                                                            <div class="card-head">
                                                                <h5 class="card-title">Data Perguruan Tinggi</h5>
                                                            </div>
                                                            <div class="row">
                                                                <div class="form-group col-lg-12">
                                                                    <label class="form-label" for="nama_pt">Nama
                                                                        Perguruan Tinggi<span
                                                                            style="color: red">*</span></label>
                                                                    <input type="text"
                                                                        value="Universitas Negeri Yogyakarta"
                                                                        class="form-control" id="nama_pt"
                                                                        disabled="">
                                                                </div>
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label" for="kode_pt">Kode
                                                                        Perguruan Tinggi<span
                                                                            style="color: red">*</span></label>
                                                                    <input type="text" value="001038"
                                                                        class="form-control" id="kode_pt"
                                                                        disabled="">
                                                                </div>
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label"
                                                                        for="provinsi_pt">Provinsi PT<span
                                                                            style="color: red">*</span></label>
                                                                    <input type="text" name="provinsi_pt"
                                                                        value="DAERAH ISTIMEWA YOGYAKARTA"
                                                                        class="form-control" id="provinsi_pt"
                                                                        disabled="">
                                                                </div>
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label" for="email_pt">Email
                                                                        Perguruan Tinggi<span
                                                                            style="color: red">*</span></label>
                                                                    <input type="text" name="email_pt"
                                                                        value="" class="form-control"
                                                                        id="email_pt">
                                                                </div>
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label" for="website_pt">Website
                                                                        Perguruan Tinggi<span
                                                                            style="color: red">*</span></label>
                                                                    <input type="text" name="website_pt"
                                                                        value="https://uny.ac.id" class="form-control"
                                                                        id="website_pt">
                                                                </div>
                                                                ...
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label"
                                                                        for="surat_pengantar">Logo Perguruan
                                                                        Tinggi<span style="color: red">*</span></label>
                                                                    <div class="input-group">
                                                                        <div class="form-file"><input type="file"
                                                                                name="file_logo_pt" accept="image/*"
                                                                    ...
                                                                    <small><span style="color: red">Unggah file jpg,
                                                                            png maksimum 2MB</span></small>
                                                                </div>
                                                                <div class="form-group col-lg-6">
                                                                    <label class="form-label"
                                                                        for="surat_pengantar">Surat Pengantar<span
                                                                            style="color: red">*</span></label>
                                                                    <div class="input-group">
                                                                        <div class="form-file"><input type="file"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card h-100">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="card-body">
                                                            <ul>
                                                                <li>- Email Perguruan Tinggi :
                                                                    <span class="text-danger">Belum Lengkap</span>
                                                                </li>
                                                                <li>- Website Perguruan Tinggi :
                                                                    <span style="color:#31b401">Lengkap</span>
                                                                </li>
                                                                <li>- Logo Perguruan Tinggi :
                                                                    <span class="text-danger">Belum Lengkap</span>
                                                                </li>
                                                                <li>- Surat Pengantar :
                                                                    <span class="text-danger">Belum Lengkap</span>
